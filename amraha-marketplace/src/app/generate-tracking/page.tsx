        ...
        <div className="max-w-5xl mx-auto bg-white shadow-xl rounded-lg p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 bg-customDarkBlue text-white font-semibold rounded-md shadow-lg disabled:bg-gray-400"
            >
              ...
              <div className="space-y-4">
                {rates.map((rate) => (
                  ...
                  >
                    ...
                    <p className="text-customDarkBlue font-bold text-xl">
          ...
          {rateId && (
            <button
              ...
              disabled={loading}
              className="mt-6 w-full py-3 bg-customDarkBlue text-white font-semibold rounded-md shadow-lg hover:bg-customDarkBlue/90 disabled:bg-gray-400"
            >
          ...
          {labelPdf && (
            <div className="text-center mt-8">
              <Link href={labelPdf} target="_blank">
                <button className="px-8 py-3 bg-customDarkBlue text-white font-semibold rounded-md shadow-lg hover:bg-customDarkBlue/90">
                  Download Shipping Label
                </button>
              </Link>
            </div>
          ...
          {trackingObj && (
            <div className="mt-8">
              ...
              <Link href={`/tracking/?labelId=${trackingObj.labelId}`}>
                <button className="mt-4 px-6 py-3 bg-customDarkBlue text-white font-semibold rounded-md shadow-lg hover:bg-customDarkBlue/90">
                  Track Shipment
                </button>
              </Link>
            </div>
